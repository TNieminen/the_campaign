...
- `tools/encounter.py` — build encounters (d20 **1–10**) for a given party, drawing monster fights from `monsters/` and/or environmental obstacles from `environments/` (`--filter monster|environmental|both`).
